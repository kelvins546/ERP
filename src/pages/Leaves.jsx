...
function LeaveModal({ leave, onClose, onSaved }) {
  const [form, setForm] = useState({
    ...
    start_date: "",
    end_date: "",
    total_days: 1, // Note: See comment in save function
    reason: "",
    status: "pending",
    ...leave,
  });
  ...
  const save = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        reason: form.reason,
        status: form.status,
        // Note: 'total_days' might not be in your standard SQL table if it's calculated on the fly.
        // If Supabase throws an error about 'total_days', you will need to run:
        // ALTER TABLE leave_requests ADD COLUMN total_days numeric;
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex justify-end gap-3 p-5 border-t">
          ...
          <Button
            onClick={save}
            disabled={
              saving || !form.employee_id || !form.start_date || !form.end_date
            }
          >
            {saving ? "Saving..." : "Save"}
          </Button>
              ...
              >
                ...
                <div className="flex gap-2 shrink-0">
                  {l.status === "pending" && (
                    <>
                      <button
                        onClick={() => quickApprove(l, "approved")}
                      ...
                      <button
                        onClick={() => quickApprove(l, "rejected")}
